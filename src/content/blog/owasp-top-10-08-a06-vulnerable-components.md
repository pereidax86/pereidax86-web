...
Arrancamos la semana con energía y llegamos al sexto puesto de nuestro [OWASP Top 10](/blog/owasp-top-10-01-introduccion). Después de ver el viernes pasado por qué [agregar seguridad al final no funciona (A05: Diseño Inseguro)](/blog/owasp-top-10-07-a05-insecure-design), hoy vamos a hablar del problema más común, más ignorado y probablemente más fácil de solucionar si se tiene la disciplina correcta: **A06 - Componentes Vulnerables y Desactualizados** (*Vulnerable and Outdated Components*).
