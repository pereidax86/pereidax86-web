...
1. [RAID](/blog/que-es-raid-guia-linux): Para que no pierdas datos si un disco muere.
2. [LVM](/blog/lvm-guia-linux): Para redimensionar particiones como si fueran de goma.
3. [ZFS](/blog/zfs-todo-en-uno-linux): El "todo en uno" superdotado y algo exigente.
